...
让你的 AI Agent（<a href="https://openclaw.ai" target="_blank">OpenClaw</a> / Claude Code）帮你管理和执行任务——创建待办、拆解步骤、自动执行、完成后通知你。

**<a href="https://lumiclaw.ai" target="_blank">LumiClaw</a> 旗下开源子项目**

---

## 截图

<img src="https://ameng-image-upload.oss-cn-shanghai.aliyuncs.com/img/CleanShot%202026-03-22%20at%2017.36.50%402x.png" alt="任务看板" />

<img src="https://ameng-image-upload.oss-cn-shanghai.aliyuncs.com/img/CleanShot%202026-03-22%20at%2017.37.00%402x.png" alt="任务详情" />
...
前往 <a href="https://github.com/LumiClaw-ai/LumiTask/releases" target="_blank">Releases</a> 下载客户端，双击打开即可。
...
LumiTask 提供完整的 REST API，详见 <a href="https://github.com/LumiClaw-ai/LumiTask/blob/main/guide/openclaw-guide.md" target="_blank">OpenClaw 集成指南</a>。
